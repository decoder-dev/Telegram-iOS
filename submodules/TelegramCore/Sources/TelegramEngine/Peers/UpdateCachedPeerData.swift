                                ...
                                case let .chatFull(messagesChatFullData):
                                    ...
                                    switch fullChat {
                                        case let .channelFull(channelFullData):
                                            ...
                                            let guardBotIdRaw = channelFullData.guardBotId
                                            ...
                                            transaction.updatePeerCachedData(peerIds: [peerId], update: { _, current in
                                                ...
                                                return previous.withUpdatedFlags(channelFlags)
                                                    ...
                                                    .withUpdatedMainProfileTab(mappedMainProfileTab)
                                                    .withUpdatedGuardBotId(guardBotIdRaw.flatMap { PeerId(namespace: Namespaces.Peer.CloudUser, id: PeerId.Id._internalFromInt64Value($0)) })
                                            })
