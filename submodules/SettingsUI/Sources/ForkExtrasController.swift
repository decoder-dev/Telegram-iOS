...
private enum ForkExtrasLocalizedString {
    private static let translations: [String: [String: String]] = [
        "en": [
            ...
            "ForkExtras.AutoFetchMtProxyFooter": "Download public MTProxy lists (SoliSpirit and kort0881), probe latency, and fail over to the fastest live server. Third-party nodes cannot read chats, but they see your IP. Manually added proxies are kept.",
        ...
        "ru": [
            ...
            "ForkExtras.AutoFetchMtProxyFooter": "Скачивать публичные списки MTProxy (SoliSpirit и kort0881), мерить задержку и переключаться на самый быстрый живой. Чужие серверы не читают чаты, но видят ваш IP. Свои прокси не удаляются.",
