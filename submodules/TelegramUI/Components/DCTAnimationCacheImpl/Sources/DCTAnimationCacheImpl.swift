...
private final class DecompressedData {
    ...
    init?(compressedData: Data, dataRange: Range<Int>) {
        ...
        // of that cleanup. (Upstream PR #2221.)
    ...
    func read(bytes: UnsafeMutablePointer<UInt8>, count: Int) throws {
        ...
        // Re-derive a live pointer here on every call instead, resuming from
        // how many source bytes compression_stream_process has consumed so far.
        // (Upstream PR #2220.)
