...
public struct ChatMessageItemLayoutConstants {
    ...
    public static var compact: ChatMessageItemLayoutConstants {
        ...
        return ChatMessageItemLayoutConstants(avatarInset: 33.0 + 4.0, timestampHeaderHeight: 40.0, timestampDateAndTopicHeaderHeight: 7.0 * 2.0 + 20.0 * 2.0 + 7.0 + 6.0, bubble: bubble, image: image, video: video, text: text, file: file, instantVideo: instantVideo, wallpapers: wallpapers)
    }
