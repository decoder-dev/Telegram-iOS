...
//
// Byte layout matches TDLib mtproto/TlsInit.cpp non-Darwin (Chrome) template: fixed cipher list,
// permuted extensions, ECH 0xfe0d, ML-KEM-768 + X25519 key shares, GREASE, padding ≥513 B.
// MTProxy still overwrites bytes [11, 43) with HMAC-SHA256(secret, record) ^ timestamp.
...
static void MTTlsHelloAppend(MTTlsHelloBuilder *builder, const void *bytes, NSUInteger length) {
...
static void MTTlsHelloBeginScope(MTTlsHelloBuilder *builder) {
    ...
    MTTlsHelloAppend(builder, zeroBytes, 2);
}
