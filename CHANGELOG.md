...
- **Message-saving export feedback:** exporting did nothing visible when the bundle could not be created (the row looked dead), and the "Exported N records" string existed in both localization tables but was never wired. Export now alerts on failure and reports the exported record count after the share sheet closes.
